...
INSERT INTO Provinces(country_id, province)
	VALUES  (1,'Buenos Aires'),
			...
			(1,'Tierra del Fuego, Ant�rtida e Islas del Atl�ntico Sur'),
			(1,'Tucum�n'),
			(2,'Beni'),
			(2,'Chuquisaca'),
			(2,'Cochabamba'),
			...
			(4,'Los Lagos'),
			(4,'Ays�n'),
			(4,'Magallanes y de la Ant�rtica Chilena'),
			(5,'Artigas'),
			(5,'Canelones'),
			(5,'Cerro Largo'),
			(5,'Colonia'),
...
INSERT INTO Supplier_categories(category, created_at)
	VALUES  ('Minimercados y almacenes','2020-03-12'),
			...
			('Perfumer�a','2020-10-25'),
			('Electr�nica','2020-12-14'),
			('Jugueter�a','2021-05-09'),
			('Libros','2021-08-16'),
			('�ptica','2021-11-11'),
			('Muebler�a','2022-01-07'),
			('Merceria','2022-07-06'),
			('Bazar','2022-10-14'),
...
INSERT INTO Product_categories(supplier_category_id,category,created_at)
	VALUES  (1,'Alimentos no perecederos','2020-03-20'),
			...
			(1,'Panader�a','2022-05-11'),
			(1,'Productos para mascotas','2022-12-04'),
			(1,'Art�culos de papeler�a','2023-07-01'),
			(2,'Papeles','2020-06-11'),
			(2,'Lapiceras y l�pices','2021-06-21'),
			(2,'Cuadernos y agendas','2021-10-10'),
			(2,'Art�culos de escritorio','2021-12-13'),
			...
			(9,'Muebles de jard�n','2022-03-21'),
			...
			(13,'Productos l�cteos','2023-12-01'),
